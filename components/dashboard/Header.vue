  ...
  >
    ...
    <div class="flex items-center justify-between gap-2">
      <button class="option-button" @click="openCardEdit()">
        ...
        <span class="px-2 text-sm font-medium text-dark-blue">Nytt kort</span>
      </button>

      <button class="option-button" @click="handleSaveProject()">
        <LucideSave :size="20" class="text-primary" />
        <span class="px-2 text-sm font-medium text-dark-blue">Lagre</span>
      </button>
...
<style scoped>
.option-button {
  @apply flex items-center justify-center rounded-md border-2 border-primary bg-white py-1.5 pl-2 pr-1 duration-200 hover:-translate-y-1;
}
